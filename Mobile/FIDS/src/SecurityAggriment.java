...
import java.util.*;
public class SecurityAggriment extends Form
...
public SecurityAggriment(LoginMidlet log,String H,String cat,String pro,String[] ProDetails)
{
super("Security Aggriment");
try{img = Image.createImage("/SecurityCrime.JPG");
