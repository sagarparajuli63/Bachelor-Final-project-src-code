...
<body text="#000000" bgcolor="#CCCCCC" onload="FP_preloadImgs(/*url*/'buttons/admin/button24.jpg',/*url*/'buttons/admin/button25.jpg',/*url*/'buttons/admin/button2D.jpg',/*url*/'buttons/admin/button2E.jpg',/*url*/'buttons/admin/button31.jpg',/*url*/'buttons/admin/button32.jpg',/*url*/'buttons/admin/button34.jpg',/*url*/'buttons/admin/button35.jpg',/*url*/'buttons/admin/button37.jpg',/*url*/'buttons/admin/button38.jpg',/*url*/'buttons/admin/button3A.jpg',/*url*/'buttons/admin/button3B.jpg',/*url*/'buttons/admin/button3D.jpg',/*url*/'buttons/admin/button3E.jpg',/*url*/'buttons/admin/button40.jpg',/*url*/'buttons/admin/button41.jpg')">
<jsp:include page="header.htm"/>

<form method="POST" action="a_Categorycode.jsp">
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#111111" width="100%" id="AutoNumber1">
    <tr>
      ...
      <a href="T_details.jsp" style="text-decoration: none; font-style: italic; font-weight: 700">
