...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td width="80%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" colspan="4" rowspan="17">
      <iframe name="t1" width="676" height="316" src="T_details1.jsp" align="center" border="0" frameborder="0">
