...
<body style="text-align: center" bgcolor="#FFFFFF" onload="FP_preloadImgs(/*url*/'buttons/button16.jpg',/*url*/'buttons/button17.jpg',/*url*/'buttons/button1B.jpg',/*url*/'buttons/button1C.jpg')">

<jsp:include page="header.htm"/>
<form name="frm" onsubmit="return validateForm()" method="POST" action="searched.jsp">
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <p align="center"><b><font color="#0000FF">Select Category :</font></b><select size="1" name="D1">
            <option selected value="Select Category">Select Category</option>

      <%
          String a=null;
      db.mkcon();
      String snt12="select * from category";
      ResultSet rs12=db.fetch(snt12);
      while(rs12.next())
      {
  		a=rs12.getString(1);
    ...
    <tr>
      <td width="25%" style="border-style: none; border-width: medium">
      <p align="center">&nbsp;<p align="center"><b><i><font color="#33CCFF">Sample Pictures</font></i></b></td>
      <td width="50%" style="border-style:none; border-width:medium; ">
      <p align="center">&nbsp;<p align="center"><b><i><font color="#33CCFF">Detail Of Products</font></i></b></td>
      <td width="25%" style="border-style:none; border-width:medium; ">
