...
var x=document.form1.cardno.value;
var y=document.form1.CVV.value;
var m=document.form1.exp_month.value;
var yr=document.form1.exp_year.value;
...
System.out.println("ip of customer system==Remote system="+IP);
...
String MyVender=request.getParameter("Vender");
String ids=request.getParameter("uid");
String passw=request.getParameter("pass");
session.setAttribute("user",ids);
session.setAttribute("upwd",passw);

//session.setAttribute("RIP",IP);
%>              
    ...
    <table cellSpacing="0" cellPadding="2" width="761" bgColor="red" border="0">
      <tr>
        ...
        <table cellSpacing="0" cellPadding="0" width="760" bgColor="white" border="0">
          ...
          <tr>
            <td width="100">
            <p align="right"><font face="arial" color="#747474" size="2"><b>
            Vender :</b></font></td>
            <td>&nbsp;<%=MyVender%></td>
          </tr>
        </table>
        <table cellSpacing="0" cellPadding="0" width="760" bgColor="white" border="0">
          <tr>
            ...
            <td align="middle">
              ...
              </table><form id="form1" onsubmit="return validateForm()" style="MARGIN: 0px" name="form1" action="PaymentCode.jsp" method="POST">
              <table cellSpacing="0" cellPadding="0" width="400" bgColor="white" border="0">
                <tr>
                  <td colSpan="2">&nbsp;</td>
                </tr>
               ...
               <input type="hidden" name="OrderNo" value="<%=ONo%>" size="20">
              
              <input type="hidden" name="YourVender" value="<%=MyVender%>" size="20">

			  <input type="hidden" name="YourDate" value="<%=complete_date%>" size="20">

			 <input type="hidden" name="YourTime" value="<%=full_comp_time%>" size="20">

			 <input type="hidden" name="YourIpAddress" value="<%=IP%>" size="20">

			 <input type="hidden" name="YourTotalPrice" value="<%=TotalPrice%>" size="20">
